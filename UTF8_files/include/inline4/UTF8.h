...
#define UTF8TextUTF8( rp, ofont, font_size,  xpos,  ypos, UTF8 ) TextUTF32( rp, ofont,  font_size,  xpos,  ypos, UTF8 )
#define UTF32TextUTF32( rp, ofont, font_size,  xpos,  ypos, UTF32 ) TextUTF32( rp, ofont,  font_size,  xpos,  ypos, UTF32 )
