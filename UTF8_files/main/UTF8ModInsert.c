...
*
*   SYNOPSIS
*      BOOL UTF8ModInsert(unsigned char *UTF8, int _start, unsigned char *UTF8_insert , ULONG flags )
*
*   FUNCTION
*
*   INPUTS
...
BOOL _UTF8_UTF8ModInsert(struct UTF8IFace *Self, unsigned char **UTF8, int _start, unsigned char *UTF8_insert , ULONG flags )
{
