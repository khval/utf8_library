...
void _UTF8_UTF8TextExtent( struct UTF8IFace *Self,struct OutlineFont *ofont, float font_size, unsigned char *UTF8, struct TextExtent *ext )
{
	ULONG glyph, pos;
	int len;
	int width, height, y0;
	...
	for ( pos = 0; (glyph = _UTF8_UTF8GetGlyph( Self, UTF8 + pos , &len )); )
	{
...
void _UTF8_UTF8TextExtentN( struct UTF8IFace *Self,struct OutlineFont *ofont, float font_size, unsigned char *UTF8, int n, struct TextExtent *ext )
{
////	struct _Library *libBase = (struct _Library *) Self -> Data.LibBase;
	ULONG glyph, pos;
	int len;
...
int _UTF8_UTF8TextLength( struct UTF8IFace *Self,struct OutlineFont *ofont, float font_size, unsigned char *UTF8 )
{
	ULONG glyph, pos;
	int len;
	ULONG xpos = 0;
...
int _UTF8_UTF8TextLengthN( struct UTF8IFace *Self,struct OutlineFont *ofont, float font_size, unsigned char *UTF8, int n )
{
	ULONG glyph, pos;
	int len;
	ULONG xpos = 0;
	...
	for ( pos = 0; ((glyph = _UTF8_UTF8GetGlyph( Self, UTF8 + pos , &len ))&&(n-->0)); )
	{
		glyph_size( Self, ofont, font_size, glyph, &width,&height,&y0 );
		xpos +=width + 2;  
		pos += len;
...
void _UTF8_UTF8Text( struct UTF8IFace *Self,struct RastPort *rp,struct OutlineFont *ofont, float font_size, int xpos, int ypos, unsigned char *UTF8 )
{
	ULONG glyph, pos;
	int len;
//	struct _Library *libBase = (struct _Library *) Self -> Data.LibBase;
...
void  _UTF8_UTF8TextN(struct UTF8IFace *     , struct RastPort * rp,struct OutlineFont *ofont, float font_size, int xpos, int ypos, unsigned char * UTF8, int n);
void _UTF8_UTF8TextN( struct UTF8IFace *Self,struct RastPort *rp,struct OutlineFont *ofont, float font_size, int xpos, int ypos, unsigned char *UTF8, int n )
{
	ULONG glyph, pos;
	int len;
//	struct _Library *libBase = (struct _Library *) Self -> Data.LibBase;
...
void _UTF8_UTF32Text( struct UTF8IFace *Self,struct RastPort *rp,struct OutlineFont *ofont, float font_size, int xpos, int ypos, ULONG *UTF32 )
{
	ULONG glyph;
	ULONG w = GetBitMapAttr( rp -> BitMap, BMA_ACTUALWIDTH );
