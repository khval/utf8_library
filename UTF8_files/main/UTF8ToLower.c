...
*
*   SYNOPSIS
*      unsigned char * UTF8ToLower(unsigned char *alphabet_UTF8,unsigned char *UTF8);
*
*   FUNCTION
*
*   INPUTS
...
unsigned char *_UTF8_UTF8ToLower(struct UTF8IFace *Self, unsigned char *alphabet_UTF8, unsigned char *UTF8, ULONG mem_flags )
{
