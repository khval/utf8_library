...
/****** UTF8/main/UTF8ModTrim ******************************************
*
*   NAME
*      Encode -- Description
*
*   SYNOPSIS
*       BOOL UTF8ModTrim( unsigned char **UTF8, ULONG mem_flags )
*
*   FUNCTION
*
*   INPUTS
...
BOOL _UTF8_UTF8ModTrim(struct UTF8IFace *Self, unsigned char **UTF8, ULONG mem_flags )
{
	BOOL ret = FALSE;
	int _start =0;
	int _end = -1;
