...
*
*   SYNOPSIS
*       unsigned char * _UTF8_UTF8SubString( unsigned char *UTF8, int _start, int _len, ULONG flags )
*
*   FUNCTION
*
*   INPUTS
...
unsigned char * _UTF8_UTF8SubString(struct UTF8IFace *Self,	unsigned char *UTF8, int _start, int _len, ULONG mem_flags )
{
	int pos, size;
	unsigned char *ret;
