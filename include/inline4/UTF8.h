...
#define UTF8Merge(mem_flags, ...) IUTF8->UTF8Merge((mem_flags), __VA_ARGS__)
...
#define UTF8Printf(codeset_page, utf8_fmt, ...) IUTF8->UTF8Printf((codeset_page), (utf8_fmt), __VA_ARGS__)
